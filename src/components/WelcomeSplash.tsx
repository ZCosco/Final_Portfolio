        ...
        >
            ...
            <div className="bg-gray-900 text-white py-10 px-8 rounded-lg mb-10 max-w-3xl text-center"> {/* Limit the maximum width */}
                ...
                <p className="text-xl mb-4">
                    ...
                    and an empty Current Projects Table. The api has routes full CRUD routes for my current projects, but for Coding Temple Projects I decided to onlt have the [GET] route. 

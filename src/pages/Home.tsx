...
function Home() {
  return (
    <div 
      ...
      className='flex flex-col justify-center items-center bg-cover bg-fixed h-screen' // Set height to full screen
    >
      ...
      {/* About Me Section */}
      <div className="bg-gray-900 text-white py-10 px-8 rounded-lg mb-10 w-1/2 text-center"> 
      ...
      {/* Contact Me Section */}
      <div className="bg-gray-900 text-white text-center py-10 px-8 rounded-lg mt-10 w-1/2"> 
